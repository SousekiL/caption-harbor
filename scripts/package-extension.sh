...
mkdir -p "$dist_dir"
temporary_dir="$(mktemp -d "$dist_dir/.caption-harbor-package.XXXXXX")"
temporary_zip="$temporary_dir/caption-harbor.zip"
output_zip="$dist_dir/caption-harbor-v$version.zip"
