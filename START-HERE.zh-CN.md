# Caption Harbor 2.1.7 完整版

2.1.7 新增词典式词义卡片，包含音标、加粗词性和带来源标签的例句。
...
**从 2.1.5／2.1.6 升级到 2.1.7 无需重装助手；更早版本首次升级到修复版时，要重新运行助手安装命令。** 助手代码是复制安装的，仅重新加载浏览器扩展不会更新它；已有模型和私有配置可保留。
