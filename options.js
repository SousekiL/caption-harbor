const YTD_OPTIONS = (() => {
  ...
  const COPY = {
    en: {
      pageTitle: "Caption Harbor Settings",
      ...
      customizationStepFolder:
        "Open the extracted Caption Harbor project folder in your coding agent.",
      ...
      saved: "Saved. Reopen Caption Harbor to use these settings.",
    ...
    "zh-CN": {
      ...
      customizationStepFolder:
        "在编程 Agent 中打开 Caption Harbor 解压后的项目文件夹。",
      customizationStepReplace:
      ...
      saved: "已保存。请重新打开 Caption Harbor 以使用这些设置。",
