...
- `api.deepseek.com`: selected text, relevant transcript excerpts, video metadata, user questions or notes when you invoke AI features. Long question context is bounded; the UI states when only excerpts were sent. Uses the existing DeepSeek Flash integration.
